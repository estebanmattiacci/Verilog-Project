...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "NBYTES_TO_RECEIVE" -parent ${Page_0}
  ipgui::add_param $IPINST -name "NBYTES_TO_SEND" -parent ${Page_0}
...
proc update_PARAM_VALUE.NBYTES_TO_RECEIVE { PARAM_VALUE.NBYTES_TO_RECEIVE } {
	# Procedure called to update NBYTES_TO_RECEIVE when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.NBYTES_TO_RECEIVE { PARAM_VALUE.NBYTES_TO_RECEIVE } {
	# Procedure called to validate NBYTES_TO_RECEIVE
	return true
}

proc update_PARAM_VALUE.NBYTES_TO_SEND { PARAM_VALUE.NBYTES_TO_SEND } {
	# Procedure called to update NBYTES_TO_SEND when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.NBYTES_TO_SEND { PARAM_VALUE.NBYTES_TO_SEND } {
	# Procedure called to validate NBYTES_TO_SEND
	return true
}
...
proc update_MODELPARAM_VALUE.NBYTES_TO_RECEIVE { MODELPARAM_VALUE.NBYTES_TO_RECEIVE PARAM_VALUE.NBYTES_TO_RECEIVE } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.NBYTES_TO_RECEIVE}] ${MODELPARAM_VALUE.NBYTES_TO_RECEIVE}
}

proc update_MODELPARAM_VALUE.NBYTES_TO_SEND { MODELPARAM_VALUE.NBYTES_TO_SEND PARAM_VALUE.NBYTES_TO_SEND } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.NBYTES_TO_SEND}] ${MODELPARAM_VALUE.NBYTES_TO_SEND}
}
